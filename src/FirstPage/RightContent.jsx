    ...
    return (
        <div className='m-2'>
            ...
            <div>
                ...
                {youtube && github && <a href="https://github.com/bytemait" target="_blank" className="text-blue-500 hover:underline ml-6"> https://byte-site.vercel.app/ </a>}
            </div>
            {/* { <button style={{ backgroundColor: "lightgreen", marginTop: 50 }}>get access to my website now</button>} */}
